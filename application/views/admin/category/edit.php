        ...
        <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
            <fieldset>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_name" value="<?php echo $category->name?>" name="name"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_sort_order" value="<?php echo $category->sort_order?>" name="sort_order"></span>
