        ...
        <table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
            ...
            <tr>
                <td colspan="6">
                    <div class="list_action itemActions">
                        <a url="<?php echo admin_url('news/delete_multi')?>" class="button blueB" id="submit" href="#submit">
            ...
            <?php foreach ($newss as $news):?>
                <tr class="row_<?php echo $news->id?>">
                    <td><input type="checkbox" value="<?php echo $news->id?>" name="id[]"></td>

                    <td class="textC"><?php echo $news->id?></td>

                    <td>
                        <div class="image_thumb">
                            <img height="50" src="<?php echo base_url('upload/news/'.$news->image_link)?>">
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="f11">
                            Xem: <?php echo $news->count_view?>
                        </div>

                    </td>

                    <td class="textC"><?php echo $news->created?></td>
                    ...
                    <td class="option textC">
                        ...
                        <a class="tipS" title="Chỉnh sửa" href="<?php echo admin_url('news/edit/'.$news->id)?>">
                            <img src="<?php echo public_url('admin/images')?>/icons/color/edit.png">
                        </a>

                        <a class="tipS verify_action" title="Xóa" href="<?php echo admin_url('news/delete/'.$news->id)?>">
