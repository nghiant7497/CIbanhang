        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="form-register">
                    ...
                    <form action="<?php echo base_url('user/edit')?>" method="post" id="form-register" accept-charset="utf-8">
                        <div class="form-box">
                            <label for="email-register">Email address * </label>
                            <input type="text" id="email-register" name="email" value="<?php echo $user_info->email; ?>">
                        </div><!-- /.form-box -->
                        <div class="form-box">
                        ...
                        <div class="form-box">
                            ...
                            <input type="password" id="repassword-register" name="re_password" placeholder="Nếu cập nhật mật khẩu thì mới nhập giá trị">
                        </div><!-- /.form-box -->
                        <div class="form-box">
                            <label for="name-register">Họ và tên * </label>
                            <input type="text" id="name-register" name="name" value="<?php echo $user_info->name; ?>">
                        </div><!-- /.form-box -->
                        <div class="form-box">
                            <label for="phone-register">Số điện thoại * </label>
                            <input type="text" id="phone-register" name="phone" value="<?php echo $user_info->phone; ?>">
                        </div><!-- /.form-box -->
                        <div class="form-box">
                            <label for="address-register">Địa chỉ * </label>
                            <input type="text" id="address-register" name="address" value="<?php echo $user_info->address; ?>">
                        </div><!-- /.form-box -->
                        <div class="form-box">
